...
async function initPopup() {
	...
	const gmailInboxElseGmailTab = browserButtonAction == BrowserButtonAction.GMAIL_INBOX && (checkerPlusBrowserButtonActionIfNoEmail == BrowserButtonAction.GMAIL_TAB || checkerPlusBrowserButtonActionIfNoEmail == BrowserButtonAction.GMAIL_IN_NEW_TAB) && unreadCount === 0;
	
    if (browserButtonAction == BrowserButtonAction.SIDE_PANEL) {
        popupUrl = "";
        ...
        if (browserButtonAction == BrowserButtonAction.CHECKER_PLUS_POPOUT || browserButtonAction == BrowserButtonAction.GMAIL_INBOX_POPOUT || browserButtonAction == BrowserButtonAction.GMAIL_DETACHED) {
            ...
            if (browserButtonAction == BrowserButtonAction.GMAIL_TAB || browserButtonAction == BrowserButtonAction.GMAIL_IN_NEW_TAB || browserButtonAction == BrowserButtonAction.COMPOSE || checkerPlusElseCompose || checkerPlusElseGmailTab || gmailInboxElseCompose || gmailInboxElseGmailTab) {
            ...
            } else if (browserButtonAction == BrowserButtonAction.SIDE_PANEL) {
                popupUrl = "";
            }
        }
