...
function openContributeDialog(key, params = {}) {
	...
	if (params.monthly) {
		...
		dialogParams.content.append(getMessage("manuallyAddingMultipleAccountsCost"), createBR(), getMessage("manuallyAddingMultipleAccountsCost2"), createBR(), getMessage("extraFeaturesPopup2"));
		...
		fetch: async function() {
            if (chrome.storage.sync) {
                ...
                if (isEmptyObject(items)) {
                    throw Error("Could not find any synced data!<br><br>Make sure you sign in to Chrome on your other computer AND this one <a target='_blank' href='https://support.google.com/chrome/answer/185277'>More info</a>");
                } else {
